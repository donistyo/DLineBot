...
def multi_tf_decision(regime_m5: Regime, regime_m15: Regime, signal_direction: str):
    ...
    - Total skor < 1.5 -> block
        WEAK+WEAK (1.0) masih diblokir -> dua TF sama-sama lemah belum cukup,
        meski arahnya searah (sesuai catatan: jangan langsung disamakan
        dengan "searah penuh").
    - Salah satu TF melawan arah sinyal -> skor TF itu 0, hampir pasti
      total < 1.5 -> block (tidak ada exception untuk WEAK yang melawan arah)
    """
